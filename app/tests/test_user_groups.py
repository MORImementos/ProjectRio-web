...
admin_api_key = db.query('SELECT api_key FROM api_key JOIN rio_user WHERE rio_user.username = %s', ('MaybeJon',))[0]['api_key']
non_admin_api_key = db.query('SELECT api_key FROM api_key JOIN rio_user WHERE rio_user.username = %s', ('GenericHomeUser',))[0]['api_key']
